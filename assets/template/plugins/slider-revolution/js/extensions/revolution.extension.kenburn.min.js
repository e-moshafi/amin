    ...
    jQuery.extend(!0, b, {
        ...
        startKenBurn: function (a, d, e) {
            ...
            if (a.data("kbtl") && a.data("kbtl").kill(), e = e || 0, 0 == a.find(".tp-kbimg").length) {
                ...
                m = void 0 === m ? "" : m, a.append('<div class="tp-kbimg-wrap ' + m + '" style="z-index:2;width:100%;height:100%;top:0px;right:0px;position:absolute;"><img class="tp-kbimg" src="' + h + '" style="position:absolute;" width="' + f.owidth + '" height="' + f.oheight + '"></div>'), a.data("kenburn", a.find(".tp-kbimg"))
            }
            var n = function (a, b, c, d, e, f, g) {
                ...
                o = function (a, b, c, d, e) {
                    var f = a.bgposition.split(" ") || "center center",
                        g = "center" == f[0] ? "50%" : "right" == f[0] || "right" == f[1] ? "0%" : "right" == f[0] || "right" == f[1] ? "100%" : f[0],
            ...
            if (t.pause(), s.start.transformOrigin = "100% 0%", s.starto.transformOrigin = "0% 0%", t.add(punchgs.TweenLite.fromTo(q, f.duration / 1e3, s.start, s.end), 0), t.add(punchgs.TweenLite.fromTo(r, f.duration / 1e3, s.starto, s.endo), 0), void 0 !== f.blurstart && void 0 !== f.blurend && (0 !== f.blurstart || 0 !== f.blurend)) {
                var u = {
                        a: f.blurstart
                    },
                    v = {
