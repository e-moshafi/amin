    ...
    jQuery.extend(!0, b, {
        ...
        organiseCarousel: function (a, b, c, d) {
            ...
            e.slides && jQuery.each(e.slides, function (d, h) {
                ...
                var j = new Object;
                j.right = i + e.inneroffset;
                var l = "center" === e.horizontal_align ? (Math.abs(e.wrapwidth / 2) - (j.right + e.slide_width / 2)) / e.slide_width : (e.inneroffset - j.left) / e.slide_width,
