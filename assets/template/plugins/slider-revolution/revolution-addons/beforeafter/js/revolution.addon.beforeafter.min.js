        ...
        onResize: function (a, c) {
            if (a && this.carousel) clearTimeout(this.resizeTimer), this.resizeTimer = setTimeout(this.resize, 250);
                ...
                if (b) {
                    ...
                    c || (b.normal ? (k = b.moveto[b.level], -1 === k.search("%") && (k = (parseInt(k, 10) * h).toFixed(0) + "px"), d = "50%") : (k = "50%", d = b.moveto[b.level], -1 === d.search("%") && (d = (parseInt(d, 10) * h).toFixed(0) + "px")), b.resetDrag(k, d))
                }
            }
        }
    };
    t.prototype = {
        ...
        updateDrag: function (a, c) {
            if (this.before) {
                ...
                this.before.style[this.size] = e + "px";
                this.after.style[this.size] = b + "px";
                this.bg.style[this.size] = b + "px";
        ...
        reset: function (a) {
            this.supress = !0;
            this.normal ? (this.revealBtn.style.top = "50%", this.revealBtn.style.left = "100%") : (this.revealBtn.style.top = "100%", this.revealBtn.style.left = "50%");
            this.before.style[this.size] =
                "100%";
        ...
        reveal: function () {
            ...
            if (this.normal) {
                if (c) {
                    ...
                    a;
                var g = "50%"
            } else c ? (g = c = a, b = 100 - b + "%") : (a = c = g = b * this.scale, b = this.sliderHeight - a), e = "50%";
            h = {
                ease: this.animation,
                delay: this.delay
            };
