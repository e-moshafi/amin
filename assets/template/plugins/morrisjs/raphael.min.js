! function (t, e) {
    ...
    return function (t) {
        ...
        var i, n;
        i = [r(3)], void 0 === (n = function (t) {
            function e(i) {
                if (e.is(i, "function")) return r ? i() : t.on("raphael.DOMload", i);
                if (e.is(i, T)) return e._engine.create[c](e, i.splice(0, 3 + e.is(i[0], A))).add(i);
            ...
            var r, i, n = /[, ]+/,
                ...
                c = "apply",
                f = "concat",
                p = "ontouchstart" in l.win || l.win.DocumentTouch && l.doc instanceof DocumentTouch,
                d = "",
                g = " ",
                x = String,
                v = "split",
            ...
            var it = function (t) {
                    if (e.vml) {
                        ...
                        s.title = "RaphaÃ«l Colour Picker", s.style.display = "none", l.doc.body.appendChild(s), it = ht(function (t) {
            ...
            e.color = function (t) {
                ...
                var n, a, s, o, l;
                return this.is(t, "object") && "h" in t && "s" in t && "l" in t && (r = t.l, e = t.s, t = t.h), (t > 1 || e > 1 || r > 1) && (t /= 360, e /= 100, r /= 100), t = (t *= 360) % 360 / 60, o = (l = 2 * e * (r < .5 ? r : 1 - r)) * (1 - B(t % 2 - 1)), n = a = s = r - l / 2, lt(n += [l, o, 0, 0, o, l][t = ~~t], a += [o, l, l, o, 0, 0][t], s += [0, 0, o, l, l, o][t], i)
            ...
            e.getRGB = ht(function (t) {
                ...
                var i = {
                    ...
                    n = [];
                return e.is(t, T) && e.is(t[0], T) && (n = mt(t)), n.length || x(t).replace(V, function (t, e, r) {
                    var a = [],
                        s = e.toLowerCase();
                ...
                if (!t) return null;
                var r = [];
                return e.is(t, T) && e.is(t[0], T) && (r = mt(t)), r.length || x(t).replace(Y, function (t, e, i) {
                    var n = [];
                    b.call(e);
                ...
                for (d = 0; d < l; d++)
                    for (var x = 0; x < h; x++) {
                        ...
                        if (S) {
                            ...
                            var A = v.t + B((S[_] - v[_]) / (y[_] - v[_])) * (y.t - v.t),
                                T = m.t + B((S[C] - m[C]) / (b[C] - m[C])) * (b.t - m.t);
                            A >= 0 && A <= 1.001 && T >= 0 && T <= 1.001 && (i ? p++ : p.push({
                                x: S.x,
                                y: S.y,
                                t1: k(A, 1),
                                t2: k(T, 1)
            ...
            function vt(t, r, i) {
                ...
                for (var n, a, s, o, l, h, u, c, f, p, d = i ? 0 : [], g = 0, x = t.length; g < x; g++) {
                    ...
                    if ("M" == v[0]) n = l = v[1], a = h = v[2];
                        ...
                        "C" == v[0] ? (n = (f = [n, a].concat(v.slice(1)))[6], a = f[7]) : (f = [n, a, n, a, l, h, l, h], n = l, a = h);
                        for (var y = 0, m = r.length; y < m; y++) {
                            var b = r[y];
                            if ("M" == b[0]) s = u = b[1], o = c = b[2];
                            else {
                                "C" == b[0] ? (s = (p = [s, o].concat(b.slice(1)))[6], o = p[7]) : (p = [s, o, s, o, u, c, u, c], s = u, o = c);
                                var _ = xt(f, p, i);
                                if (i) d += _;
                                else {
            ...
            var yt = e.pathBBox = function (t) {
                    ...
                    for (var r, i = 0, n = 0, a = [], s = [], o = 0, l = (t = At(t)).length; o < l; o++)
                ...
                bt = e._pathToRelative = function (t) {
                    ...
                    e.is(t, T) && e.is(t && t[0], T) || (t = e.parsePathString(t));
                    var i = [],
                        n = 0,
                        a = 0,
                        s = 0,
                ...
                _t = e._pathToAbsolute = function (t) {
                    ...
                    if (e.is(t, T) && e.is(t && t[0], T) || (t = e.parsePathString(t)), !t || !t.length) return [
                        ["M", 0, 0]
                    ];
                    var i = [],
                        n = 0,
                ...
                Bt = function (t, e, r, i, n, a, s, o, l, h) {
                    ...
                    if (h) T = h[0], M = h[1], C = h[2], A = h[3];
                        ...
                        T = t < C ? S - T : T, M = o < C ? S - M : M, T < 0 && (T = 2 * S + T), M < 0 && (M = 2 * S + M), s && T > M && (T -= 2 * S), !s && M > T && (M -= 2 * S)
                    }
                    var E = M - T;
                    if (B(E) > c) {
                        var N = M,
                            L = o,
                            P = l;
                        M = T + c * (s && M > T ? 1 : -1), o = C + r * _.cos(M), l = A + i * _.sin(M), d = Bt(o, l, r, i, n, 0, s, L, P, [M, N, C, A])
                    }
                    E = M - T;
                    var z = _.cos(T),
                        F = _.sin(T),
                        ...
                        Y = [o + D * j, l - q * R],
                        W = [o, l];
                    if (V[0] = 2 * O[0] - V[0], V[1] = 2 * O[1] - V[1], h) return [V, Y, W][f](d);
                    for (var G = [], H = 0, X = (d = [V, Y, W][f](d).join()[v](",")).length; H < X; H++) G[H] = H % 2 ? g(d[H - 1], d[H], p).y : g(d[H], d[H + 1], p).x;
                    return G
                },
                ...
                At = e._path2curve = ht(function (t, e) {
                    var r = !e && ft(t);
                ...
                Mt = (e._tofront = function (t, e) {
                    ...
                    Tt(t, r), e == r.top && (r.top = t), e.next && (e.next.prev = t), t.next = e.next, t.prev = e, e.next = t
                }, e._insertbefore = function (t, e, r) {
                    Tt(t, r), e == r.bottom && (r.bottom = t), e.prev && (e.prev.next = t), t.prev = e.prev, e.prev = t, t.next = e
            ...
            e._getContainer = function (t, r, i, n) {
                ...
                }, e.pathToRelative = bt, e._engine = {}, e.path2curve = At, e.matrix = function (t, e, r, i, n, a) {
            ...
            for (var zt = function () {
                    ...
                    qt = []
                }, Yt = e.el = {}, Wt = y.length; Wt--;) ! function (t) {
            ...
            Yt.drag = function (r, i, n, a, s, o) {
                function h(h) {
                    ...
                    if (this._drag.id = h.identifier, p && h.touches)
                        ...
                        start_scope: s,
                        end_scope: o
                    }), i && t.on("raphael.drag.start." + this.id, i), r && t.on("raphael.drag.move." + this.id, r), n && t.on("raphael.drag.end." + this.id, n), t("raphael.drag.start." + this.id, s || a || this, h.clientX + d, h.clientY + f, h)
                }
            ...
            var Xt = function (t, r, i, n, a, s, o, l, h) {
                    return null == h ? dt(t, r, i, n, a, s, o, l) : e.findDotsAtSegment(t, r, i, n, a, s, o, l, function (t, e, r, i, n, a, s, o, l) {
                        if (!(l < 0 || dt(t, e, r, i, n, a, s, o) < l)) {
                            var h, u = .5,
                                c = 1 - u;
                            for (h = dt(t, e, r, i, n, a, s, o, c); B(h - l) > .01;) u /= 2, h = dt(t, e, r, i, n, a, s, o, c += (h < l ? 1 : -1) * u);
                            return c
                        }
                    }(t, r, i, n, a, s, o, l, h))
                },
            ...
            Yt.animateWith = function (t, r, i, n, a, s) {
                ...
                return this
            }, t.on("raphael.remove", se), t.on("raphael.clear", se), Yt.toString = function () {
                return "RaphaÃ«lâ€™s object"
            };
            var oe, le, he = function (t) {
                    if (this.items = [], this.length = 0, this.type = "set", t)
                        for (var e = 0, r = t.length; e < r; e++) !t[e] || t[e].constructor != Yt.constructor && t[e].constructor != he || (this[this.items.length] = this.items[this.items.length] = t[e], this.length++)
                },
                ue = he.prototype;
            for (var ce in ue.push = function () {
                    for (var t, e, r = 0, i = arguments.length; r < i; r++) !(t = arguments[r]) || t.constructor != Yt.constructor && t.constructor != he || (this[e = this.items.length] = this.items[e] = t, this.length++);
                    return this
                }, ue.pop = function () {
            ...
            return ue.attr = function (t, r) {
                    ...
                    if (e.is(a, "string") && (a = this.getFont(a)), a) {
                        ...
                        for (var y = a.face.bbox[v](n), m = +y[0], b = y[3] - y[1], _ = 0, B = +y[1] + ("baseline" == o ? b + +a.face.descent : b / 2), C = 0, S = c.length; C < S; C++) {
                            ...
                            T && T.d && (g += e.transformPath(T.d, ["t", f * u, _ * u, "s", u, u, m, B, "t", (t - m) / u, (r - B) / u]))
                        }
                    }
            ...
            if (!t || t.vml) {
                ...
                var k, B = function (t, e, i) {
                    ...
                    C = function (n, l) {
                        ...
                        if ("arrow-start" in l && B(A, l["arrow-start"]), "arrow-end" in l && B(A, l["arrow-end"], 1), null != l.opacity || null != l.fill || null != l.src || null != l.stroke || null != l["stroke-width"] || null != l["stroke-opacity"] || null != l["fill-opacity"] || null != l["stroke-dasharray"] || null != l["stroke-miterlimit"] || null != l["stroke-linejoin"] || null != l["stroke-linecap"]) {
                            ...
                            if (!(j = j && j[0]) && (j = k("fill")), "image" == n.type && l.src && (j.src = l.src), l.fill && (j.on = !0), null != j.on && "none" != l.fill && null !== l.fill || (j.on = !1), j.on && l.fill) {
                                ...
                                } else j.color = t.getRGB(l.fill).hex, j.src = f, j.type = "solid", t.getRGB(l.fill).error && (A.type in {
                                    circle: 1,
                                    ellipse: 1
                                } || "r" != r(l.fill).charAt()) && S(A, l.fill, j) && (g.fill = "none", g.gradient = l.fill, j.rotate = !1)
                            }
                        ...
                        if ("text" == A.type) {
                            ...
                            v = H.style, g.font && (v.font = g.font), g["font-family"] && (v.fontFamily = g["font-family"]), g["font-weight"] && (v.fontWeight = g["font-weight"]), g["font-style"] && (v.fontStyle = g["font-style"]), X = i(g["font-size"] || X && X[0]) || 10, v.fontSize = 100 * X + "px", A.textpath.string && (H.innerHTML = r(A.textpath.string).replace(/</g, "&#60;").replace(/&/g, "&#38;").replace(/\n/g, "<br>"));
                            var U = H.getBoundingClientRect();
                            A.W = g.w = (U.right - U.left) / 100, A.H = g.h = (U.bottom - U.top) / 100, A.X = g.x, A.Y = g.y + A.H / 2, ("x" in l || "y" in l) && (A.path.v = t.format("m{0},{1}l{2},{1}", a(g.x * y), a(g.y * y), a(g.x * y) + 1));
                ...
                var M = t.st;
                for (var E in T) T[e](E) && !M[e](E) && (M[E] = function (t) {
                    return function () {
                        var e = arguments;
                        return this.forEach(function (r) {
                            r[t].apply(r, e)
        ...
        i = [r(0)], void 0 === (n = function (t) {
            if (!t || t.svg) {
                    ...
                    b = function (i, n, a) {
                        if ("path" == i.type) {
                            ...
                            if ("open" == w ? (k += 2, B += 2, C += 2, l = 1, h = a ? 4 : 1, u = {
                                ...
                                }), M.appendChild(T), p.defs.appendChild(M), g[A] = 1), x(T, u);
                                var E = l * ("diamond" != w && "oval" != w);
                                a ? (s = i._.arrows.startdx * b || 0, o = t.getTotalLength(m.path) - E * b) : (s = E * b, o = t.getTotalLength(m.path) - (i._.arrows.enddx * b || 0)), (u = {})["marker-" + v] = "url(#" + A + ")", (o || s) && (u.d = t.getSubpath(m.path, s, o)), x(y, u), i._.arrows[v + "Path"] = S, i._.arrows[v + "Marker"] = A, i._.arrows[v + "dx"] = E, i._.arrows[v + "Type"] = w, i._.arrows[v + "String"] = n
                                ...
                                switch (u[d] = g, d) {
                                    ...
                                    case "clip-rect":
                                        ...
                                        if (4 == S.length) {
                                            ...
                                            var A = x("clipPath"),
                                                T = x("rect");
                                            A.id = t.createUUID(), x(T, {
                                                x: S[0],
                                                y: S[1],
                                                width: S[2],
                                                height: S[3]
                                            }), A.appendChild(T), i.paper.defs.appendChild(A), x(l, {
                                                "clip-path": "url(#" + A.id + ")"
                                            }), i.clip = T
                                        }
                                        if (!g) {
                                    ...
                                    case "fill":
                                        ...
                                        if (N) {
                                            ...
                                            A.id = t.createUUID(), x(A, {
                                                ...
                                                }(A), i.paper.defs.appendChild(A), x(l, {
                                                    fill: "url(#" + A.id + ")"
                                                }), i.pattern = A, i.pattern && m(i);
                                            break
                                        }
                                        var P = t.getRGB(g);
                                        if (P.error) {
                ...
                S.prototype = A, A.constructor = S, t._engine.path = function (t, e) {
                    ...
                    var o, l = x("svg"),
                        h = "overflow:hidden;";
                    return i = i || 0, n = n || 0, a = a || 512, x(l, {
                        height: s = s || 342,
                        version: 1.1,
                        width: a,
                        xmlns: "http://www.w3.org/2000/svg",
                        "xmlns:xlink": "http://www.w3.org/1999/xlink"
                    }), 1 == r ? (l.style.cssText = h + "position:absolute;left:" + i + "px;top:" + n + "px", t._g.doc.body.appendChild(l), o = 1) : (l.style.cssText = h + "position:relative", r.firstChild ? r.insertBefore(l, r.firstChild) : r.appendChild(l)), (r = new t._Paper).width = a, r.height = s, r.canvas = l, r.clear(), r._left = r._top = 0, o && (r.renderfix = function () {}), r.renderfix(), r
        ...
        }, void 0 !== t && t.exports ? t.exports = x : void 0 === (i = function () {
            return x
        }.apply(e, [])) || (t.exports = i)
    }, function (t, e, r) {
        var i, n;
        i = [r(0), r(2), r(1)], void 0 === (n = function (t) {
            return t
        }.apply(e, i)) || (t.exports = n)
    }])
});