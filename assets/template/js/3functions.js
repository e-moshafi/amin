...
! function (t) {
    ...
    e.addClass("breakpoint-" + f), t(window).bind("breakpoint-change", function (t) {
            ...
            if (l.length > 0) {
                ...
                s.on("click", function (a) {
                    ...
                    s.css("display", "block"), t(".dropdown:not(.mega-menu-item) ul ul").each(function (e, a) {
                        i.width() - (t(a).width() + (i.innerWidth() - (t(a).offset().left + t(a).outerWidth()))) < 0 && t(a).addClass("menu-invert")
            ...
            i.length > 0 && i.each(function () {
                ...
                i.submit(function (n) {
                    ...
                    var r = t(this).attr("action"),
                        ...
                        d = t(this).serialize();
                    !1 === i[0].checkValidity() ? (n.stopPropagation(), i.addClass("was-validated")) : (t(i).removeClass("was-validated"), s.html('<i class="icon-loader fa-spin"> </i> در حال ارسال ...'), t.ajax({
                        url: r,
                        type: l,
                        data: d,
                        success: function (n) {
                            if ("success" == n.response) i.find(".g-recaptcha").children("div").length > 0 && grecaptcha.reset(), s.html(o), a ? window.location.href = a : t.notify({
                                ...
                                t.notify({
                                    message: "خطایی رخ داده است" || n.message
                                }, {
                                    type: "danger",
            ...
            if (t(".countdown").length > 0) {
                ...
                t(".countdown").each(function (i, e) {
                    ...
                    a.countdown(s, function (t) {
                        a.html(t.strftime('<div class="countdown-container"><div class="countdown-box"><div class="number">%-D</div><span>روز</span></div><div class="countdown-box"><div class="number">%H</div><span>ساعت</span></div><div class="countdown-box"><div class="number">%M</div><span>دقیقه</span></div><div class="countdown-box"><div class="number">%S</div><span>ثانیه</span></div></div>'))
                    })
                })
            }
        },
            ...
            if (p.length > 0) {
                ...
                e = 1 != INSPIRO.core.rtlStatus(), p.each(function () {
                    ...
                    if (a.options = {
                        ...
                        }), a.css("margin", "0 " + "0 -"  + a.options.gridMargin + "px -" + a.options.gridMargin + "px "), a.find("." + a.options.itemSelector).css("padding", "0 " + "0 "  + a.options.gridMargin + "px " + a.options.gridMargin + "px "), a.attr("data-default-filter")) {
        ...
        gridLayoutInfinite: function (i, e, a) {
            if (void 0 === t.fn.infiniteScroll) return INSPIRO.elements.notification("هشدار", "افزونه جی کوئری infiniteScroll وجود ندارد، لطفا این خط کد را <b> &lt;script src=&quot;plugins/metafizzy/infinite-scroll.min.js&quot;&gt;&lt;/script&gt;</b>, قبل از <b>plugins.js</b> اضافه کنید.", "danger"), !0;
            var s, o = i,
                n = e,
                r = a,
                l = !0,
                ...
                M = t('<div class="infinite-scroll-message"><p class="animated visible fadeIn">پست های بیشتری برای نمایش وجود ندارد</p></div>');
        ...
        yTPlayer: function () {
            ...
            if (i.length > 0) {
                if (void 0 === t.fn.YTPlayer) return INSPIRO.elements.notification("هشدار", "افزونه جی کوئری YTPlayer وجود ندارد، لطفا این خط کد را <b> &lt;script src=&quot;plugins/youtube-player/jquery.mb.YTPlayer.min.js&quot;&gt;&lt;/script&gt;</b> قبل از <b><--Template functions--\x3e</b> اضافه کنید", "danger", 1e4), !0;
                i.each(function () {
                    var i = t(this);
                    i.options = {
        ...
        vimeoPlayer: function () {
            ...
            if (i.length > 0) {
                if (void 0 === t.fn.vimeo_player) return INSPIRO.elements.notification("هشدار", "افزونه jQuery vimeo_player وجود ندارد، لطفا این خط کد را <b> &lt;script src=&quot;plugins/vimeo-player/jquery.mb.vimeo_player.min.js&quot;&gt;&lt;/script&gt;</b> قبل از <b><--Template functions--\x3e</b> اضافه کنید.", "danger", 1e4), !0;
                i.each(function () {
                    var i = t(this),
        ...
        notification: function (i, e, a, s, o, n, r, l, d, c) {
            ...
            var m = function () {
                t.notify({
                    ...
                    type: a || "warning",
                    delay: o || 1e4,
                    template: '<div data-notify="container" ' + p + ' class="bootstrap-notify ' + u + ' alert alert-{0}" role="alert"><button type="button" aria-hidden="true" class="close" data-notify="dismiss">X</button><span data-notify="icon"></span> <span data-notify="title">{1}</span> <span data-notify="message">{2}</span></div>',
                    mouse_over: !0,
                    allow_dismiss: !0,
                    placement: {
                        from: n
        ...
        clipboard: function () {
            ...
            if (i.length > 0) {
                ...
                function a(i) {
                    i.each(function () {
                        var i = t(this),
                            e = i.attr("data-original-title") || "کپی در کلیپ بورد",
                            a = i.attr("data-original-title-success") || "کپی شد!";
                        i.tooltip({
                            placement: "top",
                            title: e
                        }), i.on("click", function () {
        ...
        twitter: function () {
            var i = t(".widget-tweeter2") || t(".widget-twitter2");
            if (i.length > 0) {
                ...
                setTimeout(function () {
                    i.each(function () {
                        var i = t(this),
                            ...
                            o = i.attr("data-loading-text") || "در حال بارگزاری ...",
